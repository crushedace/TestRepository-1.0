...
# LabelEntries
myEntry1.grid(row=1, column=5, padx=10, pady=0)
myEntry2.grid(row=2, column=5, padx=10, pady=0)
myEntry3.grid(row=3, column=5, padx=10, pady=0)
myEntry4.grid(row=4, column=5, padx=10, pady=0)
# LabelButton
